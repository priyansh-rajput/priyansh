...
class IndexView(generic.ListView):
    ...
    def get_queryset(self):
        ...
        return Student.objects.filter(join_date_ite=timezone.now()).order_by('sname')
...
def create_student(sname,days):
    ...
    return Student.objects.create(sname=sname, join_date=timezone.now() + datetime.timedelta.days(days))
